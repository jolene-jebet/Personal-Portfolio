...
var typed = new Typed(".typing",{
    strings:["","Data Scientist","Statistician","Actuary","Aspiring Software Engineer"],
    typeSpeed:100,
    BackSpeed:60,
    loop:true
})
...
const nav = document.querySelector(".nav"),
     ...
     $(document).ready(function() {
        $('#btnDownloadPhotoEssay').click(function(e) {
            e.preventDefault();
            window.open("Photo-essy.pdf.pdf", '_blank');
        });
    
        $('#btnDownloadCV').click(function(e) {
            e.preventDefault();
